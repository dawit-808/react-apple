      ...
      <footer className="footer-wrapper">
        <div className="container">
          ...
          <div className="footer-links-wrapper row">
            <div className="links-wrapper-1 col-sm-6 col-md">
            ...
            <div className="links-wrapper-2 col-sm-6 col-md">
              <h3>Services</h3>
              <ul>
                <li>
            ...
            <div className="links-wrapper-3 col-sm-6 col-md">
              <h3>Apple Store</h3>
              <ul>
                <li>
            ...
            <div className="links-wrapper-4 col-sm-6 col-md">
              <h3>For Business</h3>
              <ul>
                <li>
            ...
            <div className="links-wrapper-5 col-sm-6 col-md">
              <h3>Apple Values</h3>
              <ul>
                <li>
                  <a href="#">Find a Store</a>
          ...
          <div className="copyright-wrapper row">
            <div className="copyright col-md-8 order-md-1 order-2">
              Copyright &copy; 2025 Apple Inc. All rights reserved.
            </div>
            <div className="footer-links-terms col-md-4 order-md-2 order-3">
              <ul>
                <li>
            ...
            <div className="footer-country col-md-12 order-md-3 order-1 text-md-end mb-3 mb-md-0">
